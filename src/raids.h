...
{
public:
	AnnounceEvent(Raid* raid, bool ref) :
		RaidEvent(raid, ref),
...
{
public:
	EffectEvent(Raid* raid, bool ref) :
		RaidEvent(raid, ref),
...
{
public:
	ItemSpawnEvent(Raid* raid, bool ref) :
		RaidEvent(raid, ref),
		m_itemId(0),
		m_subType(-1),
		m_chance(MAX_ITEM_CHANCE) {}
...
{
public:
	SingleSpawnEvent(Raid* raid, bool ref) :
		RaidEvent(raid, ref) {}
...
{
public:
	AreaSpawnEvent(Raid* raid, bool ref) :
		RaidEvent(raid, ref) {}
