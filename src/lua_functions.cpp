...
{
	// bit.lshift(v1, v2)
	lua_pushnumber(L, otx::lua::getNumber<int32_t>(L, 1) << otx::lua::getNumber<int32_t>(L, 2));
	return 1;
}
...
{
	// bit.ulshift(v1, v2)
	lua_pushnumber(L, otx::lua::getNumber<uint32_t>(L, 1) << otx::lua::getNumber<uint32_t>(L, 2));
	return 1;
}
